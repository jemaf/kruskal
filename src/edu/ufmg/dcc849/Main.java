...
import edu.ufmg.dcc849.sort.linear.ModifiedBucketSort;
...
public class Main {
    public static void main(String args[]) throws IOException {
        ...
        Double[] execTimeNewBucket = new Double[maxRunTime];

        Sort<Edge<Integer>> countingSort = new CountingSort();
        //Sort<Edge<Integer>> bucketSort = new BucketSort();
        Sort<Edge<Integer>> newBucketSort = new ModifiedBucketSort();
        ...
        Kruskal<Integer> newKruskalBucket = new Kruskal<Integer>(newBucketSort);
        ...
        System.out.println("Vertex_Num\tAvg_Couting\tIC_Counting\tAvg_NewBucket\tIC_NewBucket\tAvg_Quick\tIC_Quick");
        ...
        for(Integer currVertexNum = startVertexNum; currVertexNum <= endVertexNum; currVertexNum += (currVertexNum*10)/100){ //Varies the number of vertices
            ...
            for(Integer currRunTime = 0; currRunTime < maxRunTime; currRunTime++) {
                ...
                endTime = System.currentTimeMillis();
                excTimeBucket[currRunTime] = Double.valueOf(endTime - startTime);*/

                startTime = System.currentTimeMillis();
                newKruskalBucket.execute(currGraphInstance);
                endTime = System.currentTimeMillis();
                execTimeNewBucket[currRunTime] = Double.valueOf(endTime - startTime);
            ...
            Statistics newBucketStats = new Statistics(execTimeNewBucket);
            ...
            String result = currVertexNum + "\t" +
                    ...
                    newBucketStats.getMean() + "\t" + newBucketStats.getConfidenceInterval(tValue) + "\t" +
